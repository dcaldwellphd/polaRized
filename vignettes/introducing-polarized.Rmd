...
We can use the `polarize_assoc` function to get the Pearson correlation between this variable and attitudes on the different scales. Setting the `r_or_r2` argument to "r" gives:
...
Many other countries have more than two large political parties, which are not necessarily ordered on a single dimension. @Caldwell2023 introduce 
